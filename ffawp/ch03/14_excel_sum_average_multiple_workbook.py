# Date:2020/5/27
# Author:Lingchen
# Mark: 使用python为多个工作薄计算工作表级别和工作簿级别的统计量
#       python 14_excel_sum_average_multiple_workbook.py data data/output/14_output.xlsx
import glob
import sys
import os
    ...
    with open_workbook(input_file) as workbook:
        ...
        for worksheet in workbook.sheets():
            ...
            for row_index in range(1, worksheet.nrows):
                try:
                    # print(row_index)
                    # print(str(worksheet.cell_value(row_index, sales_column_index)))
                    # 当前sheet页的销售额总计
